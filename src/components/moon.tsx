...
export function MoonCard({ themeColor, status, respond }: MoonCardProps) {
  ...
  return (
    <StandardCard themeColor={themeColor} className="mt-6" noPadding={true}>
      <div className="w-full h-full p-4" style={{ backgroundColor: themeColor }}>
        <div className="bg-white/20 backdrop-blur-md p-8 w-full h-full rounded-2xl flex flex-col items-center justify-center">
